...
/**
 * Create Wish Attachment item.
 * @param {*} req
 * @param {*} res
 * @param {*} params
 */
const postWishCreate = async (req, res, params) => {
  console.log(`======${req.logiD} WISH POST CREATE:`);
  // OAuth
  ...
  // Request to WISH
  const result = await postRequest('POST', `https://${req.keel_url}/post/wish/create`, params, (response) => {
